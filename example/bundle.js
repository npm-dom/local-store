...
require.define("/index.js",function(require,module,exports,__dirname,__filename,process){var LocalStorage = typeof window !== "undefined" && window.localStorage
    , prefixes = {}
...
require.define("/example/example.js",function(require,module,exports,__dirname,__filename,process){var store = require("..")
    , body = document.body
